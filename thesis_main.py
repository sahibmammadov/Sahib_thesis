...
global angry, happy, sad, surprise, neutral, stop, male, female
angry = 0
happy = 0
sad = 0
surprise = 0
...
def all():
    global frame, angry, happy, sad, surprise, neutral, stop, male, female
            ...
            try:
                ...
                if matched_user in user_dict:
                    ...
                    if dominant_emotion == "happy":
                        ...
                        neutral += 1
                    print("neutral: ", neutral, "happy: ", happy, "sad: ", sad, "angry: ", angry, "surprise: ", surprise)
